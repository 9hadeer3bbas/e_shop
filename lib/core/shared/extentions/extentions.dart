...
extension ThemeHelper on BuildContext{
   ...
   InteractiveInkFeatureFactory get splashFactoryTheme => Theme.of(this).splashFactory;
   Color get primaryColorTheme => Theme.of(this).primaryColor;
   Color get scaffoldBackgroundColorTheme => Theme.of(this).scaffoldBackgroundColor;
   ...
   BottomNavigationBarThemeData get bottomNavigationBarThemeData => Theme.of(this).bottomNavigationBarTheme;
   DialogTheme get dialogTheme => Theme.of(this).dialogTheme;
   ButtonThemeData get buttonThemeData => Theme.of(this).buttonTheme;
   FloatingActionButtonThemeData get floatingActionButtonThemeData => Theme.of(this).floatingActionButtonTheme;
   TextButtonThemeData get textButtonThemeData => Theme.of(this).textButtonTheme;
   ElevatedButtonThemeData get elevationButtonThemeData => Theme.of(this).elevatedButtonTheme;
   OutlinedButtonThemeData get outlinedButtonThemeData => Theme.of(this).outlinedButtonTheme;
}